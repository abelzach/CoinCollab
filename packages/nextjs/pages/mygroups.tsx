...
export default function Home() {
  // const supabase = createClient("https://fymjgxjoigmiobfvqumu.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ5bWpneGpvaWdtaW9iZnZxdW11Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDIwNjY5NzksImV4cCI6MjAxNzY0Mjk3OX0.Ey1LevWVMi4Pn9lPLYfsouQZkeuFNHtJDrZvrZ7zzDA");
  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 flex-col'>
        ...
        <h2 className="ml-72 pt-4 text-4xl font-bold dark:text-white">My Groups</h2>
        <center>
          ...
          <input type="checkbox" /> 
            ...
            <div className="collapse-content"> 
              <div className='flex'>
                <div className="stats shadow">
                  <div className="stat">
                    <div className="stat-figure text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                  ...
                  <div className="stat">
                    <div className="stat-figure text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                    </div>
                  ...
                  <div className="stat">
                    <div className="stat-figure text-secondary">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                    </div>
                ...
                <button onClick={() => handleButtonClick(group.groupAddress)} className=" absolute bottom-4 right-8 p-4 btn btn-neutral ">Show more</button>
                </div>
              </div>
            </div>
          </div>
